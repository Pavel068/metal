...
class ExcelParser {
	...
	getFields() {
		...
		return {
			...
			frequency: worksheet[`AA${i}`].v,
			hod: worksheet[`AB${i}`].v,
			delta: worksheet[`AE${i}`].v,
			uglerod: worksheet[`AW${i}`].v,
		...
		while (i) {
			if (worksheet[`A${i}`]) {
				...
				plavs.push({
					...
					sechenie: parseInt(worksheet[`H${i}`].v),
					seria: seria,
					steel_mark: worksheet[`E${i}`].v,
					steel_weight: worksheet[`N${i}`].v,
					...
					frequency: parseInt(worksheet[`AA${i}`].v),
					hod: parseInt(worksheet[`AB${i}`].v),
					delta: parseInt(worksheet[`AE${i}`].v),
					uglerod: parseFloat(worksheet[`AW${i}`].v),
